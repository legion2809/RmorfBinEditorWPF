...
namespace Discord
{
    class DiscordRpc
    {
        public const string PATH = "libs/discord-rpc-w32.dll";
        
        [DllImport(PATH, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Initialize")]
        ...
        [DllImport(PATH, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_RunCallbacks")]
        public static extern void RunCallbacks();


        [DllImport(PATH, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Shutdown")]
        public static extern void Shutdown();


        [DllImport(PATH, CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_UpdatePresence")]
